 ...
 * después. Los préstamos hechos antes de esa regla arrancan el mismo día y por
 * eso se acaban un período antes de lo que debería.
 *
 * No se arregla solo ni a escondidas: lo pide alguien, porque mover las fechas
 * de un crédito que el cliente ya está pagando cambia desde cuándo está
 * atrasado.
 */
